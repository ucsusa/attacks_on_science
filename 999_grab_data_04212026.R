...
all_the_data <- all_the_data %>%
  select(full_date, week_month_year, link, article_source, agencies_involved, attack_type_variable, attack_completion)

write_csv(all_the_data, "C:/AOS_db/data/04212026_aos_data_do_not_release.csv")
