...
# And this help https://adamspannbauer.github.io/2017/12/17/summarizing-web-articles-with-r/
# And this help, https://stackoverflow.com/questions/36064946/text-summarization-in-r-language
...
write_csv(aoses_clean, "C:/Users/kellickson/OneDrive - Union of Concerned Scientists/data_analysis/aos_analysis/results/aoses_clean_aggregation.csv")
...
add_gpt_summary <- function(url_text){
  url_text <- genericSummary(url_text, k = 2, min = 6, removeXML = TRUE)
}
