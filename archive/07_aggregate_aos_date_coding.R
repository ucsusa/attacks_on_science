...
aoses_clean <- read_csv("C:/AOS_db/data/06_aos_clean_gov_si_gss.csv") %>%
...
priority_sources <- c("The Hill", "Associated Press", "Stat News", "E&E News", "Stateline Democracy", "Gov Exec", "Washington Post", "New York Times")
...
#create new data set
write_csv(aoses_clean_agg_final, "C:/AOS_db/data/07_aoses_clean_aggregate_aos.csv")
